...
class ClientAuthView extends StatelessWidget {
  const ClientAuthView({super.key});
          ...
          Align(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  RegularButton(
                    buttonAction: () =>Navigator.of(context).pushNamed(Routes.loginViewRoute),
                    buttonWidget: Text(
                      AppStrings.signIn,
                  ...
                  RegularButton(
                    buttonAction:() =>Navigator.of(context).pushNamed(Routes.clientRegistrationViewRoute),
                    buttonWidget: Text(
                      AppStrings.signUn,
                      style: Theme.of(context)
                          .textTheme
